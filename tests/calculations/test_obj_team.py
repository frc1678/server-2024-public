...
class TestOBJTeamCalc:
    ...
    def test_averages(self):
        ...
        expected_output = {
            ...
            "avg_dropped_pieces": 1.0,
            "avg_trap": 3.8,
            "avg_incap_time": 6.0,
            "avg_failed_score": 1.0,
            ...
            "lfm_avg_dropped_pieces": 1.25,
            "lfm_avg_trap": 4.0,
            "lfm_avg_incap_time": 6.5,
            "lfm_avg_failed_score": 1.25,
            "lfm_avg_failed_scores": 1.25,
    ...
    def test_standard_deviations(self):
        ...
        expected_output = {
            ...
            "lfm_sd_dropped_pieces": 2.165063509461,
    ...
    def test_extrema(self):
        ...
        expected_output = {
            ...
            "lfm_max_trap": 5,
            "lfm_max_dropped_pieces": 5,
            "lfm_max_incap_time": 8,
            "lfm_max_failed_scores": 16,
            "lfm_max_failed_score_trap": 1,
        ...
        expected_results = [
            {
                ...
                "lfm_sd_dropped_pieces": 2.165063509461097,
                "lfm_auto_sd_total_pieces": 1.118033988749895,
                "lfm_tele_sd_total_pieces": 1.118033988749895,
                # Counts
                "endgame_attempts": 4,
