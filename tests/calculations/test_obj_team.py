...
class TestOBJTeamCalc:
    ...
    def test_modes(self):
        ...
        assert self.test_calc.calculate_modes(action_categories, lfm_action_categories) == {
            ...
            "lfm_mode_stage_level_all": ["F"],
            "lfm_mode_stage_level_amp": ["O"],
            "lfm_mode_stage_level_blind": ["F"],
            "lfm_mode_stage_level_source": ["F"],
            "lfm_mode_trap_state": ["F"],
            "mode_stage_level_all": ["F"],
            "mode_stage_level_amp": ["O"],
            "mode_stage_level_blind": ["F"],
            "mode_stage_level_source": ["F"],
            "mode_trap_state": ["O"],
            "lfm_mode_trap_state": ["O"],
        }
