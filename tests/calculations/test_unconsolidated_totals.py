...
class TestUnconsolidatedTotals:
    ...
    unconsolidated_tims = [
        ...
        },
        {
            ...
            "timeline": [
                {"in_teleop": True, "time": 2, "action_type": "end_incap"},
                {"in_teleop": True, "time": 12, "action_type": "start_incap"},
                {"in_teleop": True, "time": 68, "action_type": "fail"},
    ...
    def test_calculate_unconsolidated_tims(self):
        ...
        assert calculated_tim == {
            ...
            "tele_ferry_drive": 0,
            "tele_ferry_shoot": 0,
            "tele_failed_ferry_shoot": 0,
            "tele_unamplified_speaker": 3,
            "tele_amp": 1,
            "tele_failed_amp": 0,
            "tele_failed_unamplified_speaker": 1,
            "tele_total_pieces": 5,
            "tele_total_speaker_notes": 4,
            "tele_total_failed_speaker_notes": 2,
            ...
            "auto_intakes_center": 0,
            "auto_intakes_spike": 0,
            "tele_amplified": 1,
            "tele_drop": 0,
